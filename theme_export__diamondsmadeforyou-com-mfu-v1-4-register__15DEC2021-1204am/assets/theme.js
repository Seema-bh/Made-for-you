...
$(document).ready(function() {
  ...
  //REGISTER FORM INITIAL VALIDATION
  function ValidateRegisterForm() {
    ...
    var firstName = $('[name="customer[first_name]"]'),
        ...
        confirmPassword = $('[data-password-reenter]');
    
    $('#RegisterForm input').removeClass('input--error');
    $('#RegisterForm [data-form-error]').html('').hide();
    ...
    if(validation == true) {
      ...
      $('.form__submission .spinner').removeClass('hide');
      $('.form__submission .sign-up-text').addClass('hide');
    }
    return validation;
  }
  
  $('#RegisterForm .btn').on('click', function(e) {
  ...
  $('#RegisterForm input').on('click', function() {
//     $(this).removeClass('input--error').next('[data-form-error]').hide();
    $(this).removeClass('input--error').closest('.input__group').find('[data-form-error]').hide();
  });
  
  $('#RegisterForm .select-container .dropdown').on('click', function() {
    $(this).closest('.input__group').removeClass('input--error').find('[data-form-error]').hide();
  });
