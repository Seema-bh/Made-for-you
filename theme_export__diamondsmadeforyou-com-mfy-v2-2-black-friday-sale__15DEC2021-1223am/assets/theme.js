...
slate.Variants = (function() {
  ...
  function selectOption(variant){
    if (variant) {
      var form = $('.swatches').closest('form');
...
//     alert();
    ...
    selectOption(this.currentVariant);
  ...
  Variants.prototype = Object.assign({}, Variants.prototype, {
    ...
    _getVariantFromOptions: function() {
      ...
      var productTypeLoad = theme.productType;
      if(productTypeLoad.indexOf('Ring')>-1){
        var ringSizeArray = '5 6 8 9';
        var selectedSize = found.option2;
        console.log(selectedSize);
        if(selectedSize && ringSizeArray.indexOf(selectedSize)>-1){
          $('.swatch.size .infor').css('display','inline-block');
        }
      }
  ...
  function positionFullWidthDropdowns() {
    document
      ...
      .forEach(function(el) {
        ...
        var fullWidthDropdownOffset = el.offsetTop + 44;
...
$(document).ready(function() {
  ...
  var homePage = {
    ...
    headerScroll: function(){
      ...
      function hasScrolled() {
        ...
        if (st > lastScrollTop && st > navbarHeight){
          // Scroll Down
          $('.announcement-header-wrapper').removeClass('nav-down').addClass('nav-up');
        } else if(st > 50) {
          // Scroll Up
          if(st + $(window).height() < $(document).height()) {
            $('.announcement-header-wrapper').removeClass('nav-up').addClass('nav-down');
          }
        }else{
          $('.announcement-header-wrapper').removeClass('nav-up').removeClass('nav-down');
        }
    ...
    initCollectionProductSlider: function() {
      var collectionSlider = $('.collection_list .grid-slider');
      ...
      if (collectionSlider.length && collectionSliderCount > 2) {
        collectionSlider.slick({
          ...
          slidesToScroll: 1,
          autoplay: false,
          prevArrow:'<button type="button" class="slick-prev slick-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26"><defs><style>.slider-arrow-a{fill:#fff;opacity:0;}</style></defs><g transform="translate(-1200 -727)"><rect class="slider-arrow-a" width="26" height="26" transform="translate(1200 727)"/><g transform="translate(77.485 34.543)"><path d="M607.71,1755.018a10.889,10.889,0,0,1,0-21.778h0a10.889,10.889,0,0,1,0,21.778Zm0-21.317v.461a9.967,9.967,0,0,0,0,19.933h0a9.967,9.967,0,0,0,0-19.933Z" transform="translate(527.363 -1039.045)"/><path d="M607.276,1749.476a.46.46,0,0,1-.326-.135l-4.376-4.376a.461.461,0,0,1,0-.652l4.376-4.376a.461.461,0,0,1,.652.652l-4.049,4.05,4.049,4.05a.461.461,0,0,1-.326.787Z" transform="translate(529.415 -1039.555)"/></g></g></svg></button>',
          nextArrow:'<button type="button" class="slick-next slick-arrow"><svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" viewBox="0 0 26 26"><defs><style>.slider-arrow-a{fill:#fff;opacity:0;}</style></defs><g transform="translate(-1232 -727)"><rect class="slider-arrow-a" width="26" height="26" transform="translate(1232 727)"/><g transform="translate(1233.67 728.738)"><path d="M607.711,1755.017a10.889,10.889,0,0,0,0-21.777h0a10.889,10.889,0,0,0,0,21.777Zm0-21.316v.461a9.966,9.966,0,0,1,0,19.933h0a9.966,9.966,0,0,1,0-19.933Z" transform="translate(-596.821 -1733.24)"/><path d="M602.9,1749.476a.46.46,0,0,0,.326-.135l4.376-4.376a.461.461,0,0,0,0-.652l-4.376-4.376a.461.461,0,0,0-.652.652l4.049,4.05-4.049,4.05a.461.461,0,0,0,.326.787Z" transform="translate(-593.627 -1733.751)"/></g></g></svg></button>',
          responsive: [
            {
              breakpoint: 1025,
              settings: {
  ...
  var productPage = {
    productThumbnilSlider:function(){
      ...
      var lookSlider= $('.inspired-collection .inspired-collection_slider');
    ...
    swatchVariantChange: function() {
      $('.swatch :radio').change(function() {
        var optionIndex = jQuery(this).closest('.swatch').attr('data-option-index');
        var optionValue = jQuery(this).val();
        var ringSizeArray = '5 6 8 9';
        $(this).closest('form').find('.single-option-selector').eq(optionIndex).val(optionValue).trigger('change');
        var option1 = $('.single-option-selector[data-index="option1"]').val();
        var option2 = $('.single-option-selector[data-index="option2"]').val();
        if(option2 != undefined){
          var finalOption = option1+" / "+option2;
        }else{
          var finalOption = option1;
        }
        var productType = theme.productType;
        if(productType.indexOf('Ring')>-1 && ringSizeArray.indexOf(optionValue)>-1){
          $('.swatch.size .infor').css('display','inline-block');
        }else{
          $('.swatch.size .infor').css('display','none');
        }
        //           console.log(option1,option2,finalOption);
        var valofText = $('[name="id"] option').filter(function() {
          return this.text == finalOption
        }).val();
        
        var variantMetalName = $('.swatch.metal .swatch-element input:checked + label').attr("data-colorname");
        $('.header .metalName').text(variantMetalName);
        console.log(valofText);
        $('[name="id"]').val(valofText).change();
      });

      $('[name="id"]').on('change',function(){
        console.log('tesx');
        var variant = $(this).val();
        var variantSku = $(this).children('option:selected').data('sku');
        var isVariantAvailable = $(this).children('option:selected').data('available');
        var variantPriceWithCurrency = $(this).children('option:selected').data('price');
        var variantComparePriceWithCurrency = $(this).children('option:selected').data('compare-price');
        var variantPriceWithoutCurrency = parseInt($(this).children('option:selected').data('price-without-currency'));
        var variantComparePriceWithoutCurrency = parseInt($(this).children('option:selected').data('compare-price-without-currency'));
        console.log(variantComparePriceWithoutCurrency,variantPriceWithoutCurrency);
        $('.price__regular [data-regular-price]').text(variantPriceWithCurrency);
        $('.price__sale [data-sale-price]').text(variantPriceWithCurrency);
        $('.price__sale [data-regular-price]').text(variantComparePriceWithCurrency);
        
        if((variantComparePriceWithoutCurrency>variantPriceWithoutCurrency)&& variantPriceWithoutCurrency!=NaN){
          $('.product__price .price').addClass('price--on-sale');
        }
        
        if((variantComparePriceWithoutCurrency<variantPriceWithoutCurrency)&& variantPriceWithoutCurrency!=NaN){
          $('.product__price .price').removeClass('price--on-sale');
        }
        
        $('.product-sku span').text(variantSku);
        function variantAvailable(){
          $(".estimated_date").removeClass('hide');
          $('.product-form__item--submit').find('[name="add"]').attr('aria-label','Add to cart').text('Add to cart');
          $('.product-form__item--submit').find('[name="add"]').show();
          $('#BIS_trigger').hide();
          $('.product-form').removeClass('product-form--variant-sold-out');
        }
        function variantNotAvailable(){
          $(".estimated_date").addClass('hide');
          $('.product-form__item--submit').find('[name="add"]').attr('aria-label','Sold out').text('Sold out');
          $('.product-form__item--submit').find('[name="add"]').hide();
          $('#BIS_trigger').show();
          $('.product-form').addClass('product-form--variant-sold-out');
        }
        if(isVariantAvailable != undefined){
          isVariantAvailable == false ? variantNotAvailable() : variantAvailable();
        }
        var newurl =window.location.protocol +'//' +window.location.host +window.location.pathname +'?variant='+variant;
        window.history.replaceState({ path: newurl }, '', newurl);
      });

      $(document).on('click','.item-swatch li a',function(e){
        e.preventDefault();
        var swatchLink = $(this).attr('href');
        var firstImage = $(this).data('first-image');
        var secondImage = $(this).data('second-image');
        $(this).closest('.product-card').find('.mm-product-link').attr('href',swatchLink);
        $(this).closest('.product-card').find('.images-first').attr('srcset',firstImage).attr('src',firstImage);;
        $(this).closest('.product-card').find('.images-two img').attr('srcset',secondImage).attr('src',secondImage);;
      });
    }
  }
  ...
  var MobileMenu = {
    ...
    openSubmenu: function() {
      $('.has-submenu .toggle-icon').click(function() {
        $(this).closest('.has-submenu').toggleClass('has--closed');
        var dataLevel = $(this).closest('.has-submenu').find('a').data('menu');
        console.log(dataLevel);
        $('[data-parent="'+dataLevel+'"]').slideToggle();
        event.stopPropagation();
      });
    }
  }
  ...
  var promotionPopup = {
    promotionPopup: function() {
      ...
      $("#promotion-popup [type='button']").click(function(e){
        e.preventDefault();
        $('.content-form-info').addClass('hide');
        $('.content-thank-you').removeClass('hide');
      });   
    },
    promotionSubscripiton: function() {
      $('#promotion-popup .popup-content form').on('submit',function(e){
        ...
        if(emailId == '') {
          ...
          emailError.hide();
          $('.content-form-info .ajax-loader').removeClass("hide");
          $('.content-form-info .submit_btn .btn').css('color','transparent');
        }

        $.ajax({
          type: "POST",
          url: "https://mfy.anivedcapital.com/sendInBlue/api.php",
          data: {email:emailId},
          dataType: "text",
          async: false,
  ...
  productPage.swatchVariantChange();
  ...
  promotionPopup.promotionSubscripiton();
  ...
  //AJAX ADD single product to CART - shop the look
  $(document).on('click','.single-variant-add-cart',function(){
    var data = [];
    var variantId = $(this).closest('.price-button-wrapper').attr('data-product-default-variantid');
    var newArr = {quantity: 1,id: variantId}
    data.push(newArr);
    console.log(data);
    $.ajax({
      type: 'POST',
      ...
      success: function(cart) {
        ...
        $.getJSON('/cart.js', function(cart) {
          ...
          $('.mm-cart-count,[data-cart-count]').html(currentCartCount);
        });
      },
  ...
  //AJAX ADD all TO CART - shop the look
  $(document).on('click','.look-add-all',function(){
    var data = [];
    $(this).closest('.lookbook-parent').find('li.grid__item').each(function(){
      if($(this).find('.lookbook-product').is(":checked") && $(window).width()<768){
        var variantId = $(this).find('.price-button-wrapper').attr('data-product-default-variantid');
        var newArr = {quantity: 1,id: variantId}
        data.push(newArr);
        $('.lookbook-parent .error').hide();
      }
      if($(window).width()>767){
        var variantId = $(this).find('.price-button-wrapper').attr('data-product-default-variantid');
        var newArr = {quantity: 1,id: variantId}
  ...
  // Lookbook checkbox price update functionlity  
  $('.lookbook-parent li .lookbook-product').on('change',function(){
    var totalPrice = 0;
    var totalComparePrice = 0;
    var checkboxLength = 0;
    $(this).closest('.lookbook-parent').find('li.grid__item').each(function(){
      if($(this).find('.lookbook-product').is(":checked")){
        var price = parseInt($(this).find('.price-button-wrapper').attr('data-product-default-variantprice'));
        var comparePrice = parseInt($(this).find('.price-button-wrapper').attr('data-product-default-variantComparePrice')) || parseInt($(this).find('.price-button-wrapper').attr('data-product-default-variantprice'));
        totalPrice += price
    ...
    if(checkboxLength == 0){
      $(this).closest('.lookbook-parent').find('.look-add-all').prop('disabled',true);
    }else{
      $(this).closest('.lookbook-parent').find('.look-add-all').prop('disabled',false);
    }
    var totalPriceWithCurrency = theme.Currency.formatMoney(totalPrice, theme.moneyFormat);
    var totalComapreWithCurrency = theme.Currency.formatMoney(totalComparePrice, theme.moneyFormat);
    console.log(totalPriceWithCurrency,totalComapreWithCurrency,checkboxLength);
    $(this).closest('.lookbook-parent').find('.total-price .lprice').text(totalPriceWithCurrency);
    if(totalPrice != totalComparePrice){
      $(this).closest('.lookbook-parent').find('.total-price .comparePrice').text(totalComapreWithCurrency);
    }
  });
  
  $('.lookbook-parent').each(function(){
    var totalPrice = 0;
    var totalComparePrice = 0;
    var checkboxLength = 0;
  	$(this).closest('.lookbook-parent').find('li.grid__item').each(function(){
    ...
    var totalPriceWithCurrency = theme.Currency.formatMoney(totalPrice, theme.moneyFormat);
    var totalComapreWithCurrency = theme.Currency.formatMoney(totalComparePrice, theme.moneyFormat);
    $(this).find('.total-price .lprice').text(totalPriceWithCurrency);
    if(totalPrice != totalComparePrice){
      $(this).find('.total-price .comparePrice').text(totalComapreWithCurrency);
    }
    if(checkboxLength == 0){
      $(this).closest('.lookbook-parent').find('.look-add-all').prop('disabled',true);
    }else{
  ...
  $(document).on('click', '.product-form button[name="add"]', function(e) {
    e.preventDefault();
    var productArr = [];
    var currenctProductVariantId = $(this).closest('form').find('#ProductSelect-product-template').val();
    var object = {id:currenctProductVariantId,quantity:1}
    productArr.push(object);
    var chainPorductId = $('[name="chain-product-id"]').val();
    //     alert(chainPorductId);
    if(chainPorductId != '' && chainPorductId != undefined ){
      object = {id:chainPorductId,quantity:1}
      productArr.push(object);
    }
    ...
    function ajaxAdd(data) {
      $.ajax({
        ...
        error: function (error) {
          ...
          $('.product-form__error-message-wrapper').removeClass('product-form__error-message-wrapper--hidden').find('[data-error-message]').text(error.responseJSON['description']);
          $this.find("span").removeClass("hide");
          $this.find("[data-loader]").addClass("hide");
        }
      });
  ...
  // Ajax Cart Drawer Checkout btn  
  $(document).on('click', '.cart__footer [data-submit]', function(e) {
    $(this).find("span:first-child()").addClass("hide");
    $(this).find("[data-loader]").removeClass("hide");
  });
});
...
$(document).ready(function() {
  ...
  if(pageName.indexOf('template-index')>-1){
    var videos = document.getElementsByTagName("myVideo2");
  ...
  // show loader on click of swatches
  $('.swatches .swatch.metal .swatch-element ').on('click',function(){
  	$(this).closest('.swatches').find('.lazy-load').css('display','flex');
  });
  ...
  // Materials and care slider
  $('.mc-columns-slider').slick({
    dots: false,
    arrows: false,
    infinite: false,
    speed: 500,
